...
const Hero = () => {
  return (
    <div className="px-5 xl:px-10 md:w-1/2 mb-10">
        ...
        Let's Enjoy Cooking With Cook It
        </h1>
        ...
        <input className="outline-none w-full placeholder:text-[##1b2629]"  name="query" placeholder="Search for a recipe" type="search" id="search" required=""/>
