...
const ContactPage = () => {
  return (
    ...
    <div className="container px-6 lg:px-12 mx-auto">
        <div>
            <p className="font-medium text-btnColor dark:text-blue-400">Contact us</p>

            <h1 className="mt-2 text-2xl font-semibold text-secondary md:text-3xl">Chat to our friendly team</h1>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <span className='p-2.5 text-blue-500 rounded-full bg-blue-100/80'><FaEnvelope className="inline-block "/></span>
                    

                    <h2 className="mt-4 text-base font-medium text-gray-800 dark:text-white">Email</h2>
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">hello@cookit.com</p>
                </div>

                <div>
                <span className='p-2.5 text-blue-500 rounded-full bg-blue-100/80'><FaMapMarked className="inline-block "/></span>
                ...
                <div>
                <span className='p-2.5 text-blue-500 rounded-full bg-blue-100/80'><FaHome className="inline-block "/></span>
                ...
                <div>
                <span className='p-2.5 text-blue-500 rounded-full bg-blue-100/80'><FaPhone className="inline-block "/></span>
